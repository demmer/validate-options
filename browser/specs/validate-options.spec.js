(function (factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        // like Node.
        module.exports = factory(require('chai'), require('validate-options'));
    } else {
        // Browser globals
        this.validate_options_specs = factory(chai, validateoptions);
    }
}(function (__external_chai, __external_validateoptions) {
    ...
    _require.modules = [
        function (module, exports) {
            ...
            module.exports.hasAll = function hasAll() {
                ...
                if (missing.length) {
                    var err = 'Missing required option' + (missing.length > 1 ? 's' : '') + ': ' + missing.join(', ');
            ...
            module.exports.hasOne = function hasOne() {
                ...
                throw new errorClass('Missing at least one required option from' + ': ' + opts.join(', '));
            };    //
            ...
            describe('validate options', function () {
                describe('hasAll', function () {
                    ...
                    it('supports an option accessor callback', function () {
                        expect(validateOpts.hasAll(function (key) {
                            return {
                                a: 'abc',
                                b: 'def'
                            }[key];
                        ...
                        expect(function () {
                            return validateOpts.hasAll(function (key) {
                                return { a: 'abc' }[key];
                            }, 'a', 'b');
                        }).throws(Error);
                    });
